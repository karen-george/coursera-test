...
function buildAndShowHomeHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (homeHtml) {
      ...
      //
      var insertProperty = function (string, randomCategoryShortName, chooseRandomCategory) {
      var propToReplace = "{{" + randomCategoryShortName + "}}";
      string = string
      	.replace(new RegExp(propToReplace, "g"), chooseRandomCategory);
      return string;
